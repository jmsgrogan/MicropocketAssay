...
if __name__ == "__main__":
    ...
    plot_3d("/home/grogan/test_sampled.vtp", coords, z_eval, name="Sampled")
    z_fit = simple_evaluate_fit(coords, v_fit, rho_fit, k_fit, a_fit)
    plot_3d("/home/grogan/test_fit.vtp", coords, np.array(z_fit)*0.02, name="Fit")
#     plot_3d("/home/grogan/test_simp.vtp", coords, z_simp, name="Fit")
