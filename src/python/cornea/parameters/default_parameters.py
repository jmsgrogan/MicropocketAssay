...
_default_collection.add_parameter(Parameter("CorneaRadius", 1300.0*1.e-6*metres,
                                           min_val = 1.0, max_val = 1.0, symbol = "R",
                                           nice_name = "Cornea Radius"))
_default_collection.add_parameter(Parameter("CorneaThickness", 100.0*1.e-6*metres,
                                           min_val = 1.0, max_val = 1.0, symbol = "T",
                                           nice_name = "Cornea Thickness"))
_default_collection.add_parameter(Parameter("PelletHeight", 1000.0*1.e-6*metres,
                                           min_val = 0.8, max_val = 1.2, symbol = "h",
                                           nice_name = "Pellet Height"))
_default_collection.add_parameter(Parameter("PelletRadius", 200.0*1.e-6*metres,
                                           min_val = 1.0, max_val = 1.0, symbol = "r",
                                           nice_name = "Pellet Radius"))
_default_collection.add_parameter(Parameter("PelletThickness", 40.0*1.e-6*metres,
                                           min_val = 1.0, max_val = 1.0, symbol = "r",
                                           nice_name = "Pellet Thickness"))
_default_collection.add_parameter(Parameter("LimbalOffset", 100.0*1.e-6*metres,
                                           min_val = 1.0, max_val = 1.0, symbol = "\epsilon",
                                           nice_name = "Limbal Offset"))

# Domain Numerics and Sampling
_default_collection.add_parameter(Parameter("GridSpacing", 40.0*1.e-6*metres,
...
# PDE Details
_default_collection.add_parameter(Parameter("PelletConcentration", 300.0*1.e-6*mole_per_metre_cubed, 
...
# Simulation Details
_default_collection.add_parameter(Parameter("TotalTime", 48.0*3600.0*seconds))
_default_collection.add_parameter(Parameter("TimeStepSize", 1.0*3600.0*seconds))
