...
_default_collection.add_parameter(Parameter("CorneaThickness", 100.0e-6*metre(), 
                                           min_val = 1.0, max_val = 1.0, symbol = "T", 
                                           nice_name = "Cornea Thickness"))
_default_collection.add_parameter(Parameter("PelletHeight", 1.0e-3*metre(),
                                           min_val = 0.8, max_val = 1.2, symbol = "h", 
                                           nice_name = "Pellet Height"))
_default_collection.add_parameter(Parameter("PelletRadius", 200.0e-6*metre(),
                                           min_val = 1.0, max_val = 1.0, symbol = "r", 
                                           nice_name = "Pellet Radius")) 
_default_collection.add_parameter(Parameter("PelletThickness", 40.0e-6*metre(),
                                           min_val = 1.0, max_val = 1.0, symbol = "r", 
                                           nice_name = "Pellet Thickness")) 
_default_collection.add_parameter(Parameter("LimbalOffset", 100.0e-6*metre(),
                                           min_val = 1.0, max_val = 1.0, symbol = "\epsilon", 
                                           nice_name = "Limbal Offset")) 

# Domain Numerics and Sampling
_default_collection.add_parameter(Parameter("GridSpacing", 40.0e-6*metre(), 
                                           min_val = 1.0, max_val = 1.0, symbol = "\Delta x", 
                                           nice_name = "Grid Spacing")) 
_default_collection.add_parameter(Parameter("ElementArea2d", 1e3*(1.e-18*metre_cubed())))
_default_collection.add_parameter(Parameter("ElementArea3d", 1e4*(1.e-18*metre_cubed())))                                    
_default_collection.add_parameter(Parameter("NodeSpacing", 40.0e-6*metre(), 
                                           min_val = 1.0, max_val = 1.0, symbol = "\Delta n", 
                                           nice_name = "Node Spacing"))   
_default_collection.add_parameter(Parameter("DensityGridSpacing", 40.0e-6*metre(),
                                           min_val = 1.0, max_val = 1.0, symbol = "\Delta x_{\rho}", 
                                           nice_name = "Density Grid Spacing")) 
_default_collection.add_parameter(Parameter("SampleSpacingX", 60.0e-6*metre(),
                                           min_val = 1.0, max_val = 1.0, symbol = "\Delta x_{s}", 
                                           nice_name = "Sample Spacing X")) 
_default_collection.add_parameter(Parameter("SampleSpacingY", 60.0e-6*metre(),
                                           min_val = 1.0, max_val = 1.0, symbol = "\Delta y_{s}", 
                                           nice_name = "Sample Spacing Y"))   
_default_collection.add_parameter(Parameter("SampleSpacingZ", 33.0e-6*metre(),
...
_default_collection.add_parameter(Parameter("SproutingProbability", 0.5 /(3600.0*second()), 
