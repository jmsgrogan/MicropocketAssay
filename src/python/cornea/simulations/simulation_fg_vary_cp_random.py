...
if __name__ == '__main__':
    ...
    studies.append({"name": "fixed_gradient_1",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 0.5e-7*mole_per_metre_cubed,
                                 "PersistenceAngle": 20.0,
                                 "ChemotacticStrength": 0.0,
                                 "OnlyPerfusedSprout": True}})
    studies.append({"name": "fixed_gradient_5",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 1.0e-7*mole_per_metre_cubed,
                                 "PersistenceAngle": 20.0,
                                 "ChemotacticStrength": 0.0,
                                 "OnlyPerfusedSprout": True}})
    studies.append({"name": "fixed_gradient_10",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 1.5e-7*mole_per_metre_cubed,
                                 "PersistenceAngle": 20.0,
                                 "ChemotacticStrength": 0.0,
                                 "OnlyPerfusedSprout": True}})
    studies.append({"name": "fixed_gradient_15",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 2.0e-7*mole_per_metre_cubed,
                                 "PersistenceAngle": 20.0,
                                 "ChemotacticStrength": 0.0,
                                 "OnlyPerfusedSprout": True}})
    studies.append({"name": "fixed_gradient_20",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 2.5e-7*mole_per_metre_cubed,
                                 "PersistenceAngle": 20.0,
                                 "ChemotacticStrength": 0.0,
                                 "OnlyPerfusedSprout": True}})
    ...
    work_dir = "Python/Cornea/Study_fg_vary_cp_random" + str(run_id) + "/"
