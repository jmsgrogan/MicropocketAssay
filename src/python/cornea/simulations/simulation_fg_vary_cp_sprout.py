...
if __name__ == '__main__':
    ...
    studies.append({"name": "fixed_gradient_1",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 0.05e-7*mole_per_metre_cubed,
                                 "ChemotacticStrength": 1.0}})
    studies.append({"name": "fixed_gradient_5",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 0.1e-7*mole_per_metre_cubed,
                                 "ChemotacticStrength": 1.0}})
    studies.append({"name": "fixed_gradient_10",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 0.15e-7*mole_per_metre_cubed,
                                 "ChemotacticStrength": 1.0,
                                 "OnlyPerfusedSprout": True}})
    studies.append({"name": "fixed_gradient_15",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 0.2e-7*mole_per_metre_cubed,
                                 "ChemotacticStrength": 1.0}})
    studies.append({"name": "fixed_gradient_20",
                    "switches": {"UseFixedGradient": True,
                                 "PelletConcentration": 0.25e-7*mole_per_metre_cubed,
                                 "ChemotacticStrength": 1.0} })
    ...
    work_dir = "Python/Cornea/Study_fg_vary_cp_sprout" + str(run_id) + "/"
